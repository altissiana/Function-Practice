...
function maxOfThree(num1, num2, num3){
  ...
  var max = maxOfThree(2,56,3)
  var max = maxOfThree(12,3,4)
  var max = maxOfThree(-12,4,-5)
...
//I DON'T KNOW HOW, NEED HELP PLEASE!
...
function reverse(str) {
 ...
 var str = reverse("books")
 var str = reverse("we don't want no trouble")
